...
# print ('Введите число:')
# num = float(input())
# print ('Введите количество знаков после запятой (точность):')
# a=int(input()) 
# print("Ваше число:",round(num,(a))) 
...
# List = [66,66,'qwerty', 'asd', 'asd',5,8,8,9,90,1025]
...
# def write_file(st):
#     with open('fileHW2.txt', 'w') as data:
#         data.write(st)
